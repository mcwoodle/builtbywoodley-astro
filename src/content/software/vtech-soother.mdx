---
title: "VTech Soother Integration"
...
summary: "An unofficial Home Assistant custom integration that controls a BLE soother locally -- bypassing the vendor cloud to expose power, color, brightness, timers, and routines to HA automations."
