...
summary: "A python data pipeline that started as a curiosity on visualizing crime data in the GTA with Kepler.gl, and led to playing around with establishing a full data pipeline including census data."
stack: ["Python", "pandas", "GeoPandas", "Pandera", "kepler.gl", "uv"]
repoUrl: "https://github.com/mcwoodle/gta-urban-analytics"
liveUrl: "/software/gta-map"
order: 1
---
...
<a href="/software/gta-map" target="_blank" rel="noopener">
